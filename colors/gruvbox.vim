...
let s:gb.dark0_hard  = ['#1d2021', 16]     " 29-32-33
let s:gb.dark0       = ['#282828', 232]     " 40-40-40
let s:gb.dark0_soft  = ['#32302f', 232]     " 50-48-47
let s:gb.dark1       = ['#3c3836', 234]     " 60-56-54
let s:gb.dark2       = ['#504945', 236]     " 80-73-69
let s:gb.dark3       = ['#665c54', 237]     " 102-92-84
let s:gb.dark4       = ['#7c6f64', 238]     " 124-111-100
let s:gb.dark4_256   = ['#7c6f64', 239]     " 124-111-100

let s:gb.gray_245    = ['#928374', 236]     " 146-131-116
let s:gb.gray_244    = ['#928374', 244]     " 146-131-116

let s:gb.light0_hard = ['#f9f5d7', 230]     " 249-245-215
let s:gb.light0      = ['#fbf1c7', 229]     " 253-244-193
let s:gb.light0_soft = ['#f2e5bc', 228]     " 242-229-188
let s:gb.light1      = ['#ebdbb2', 249]     " 235-219-178 font color
let s:gb.light2      = ['#d5c4a1', 250]     " 213-196-161
let s:gb.light3      = ['#bdae93', 248]     " 189-174-147
let s:gb.light4      = ['#a89984', 244]     " 168-153-132
let s:gb.light4_256  = ['#a89984', 246]     " 168-153-132

let s:gb.bright_red     = ['#fb4934', 167]     " 251-73-52
let s:gb.bright_green   = ['#b8bb26', 28]     " 184-187-38
let s:gb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47
let s:gb.bright_blue    = ['#83a598', 69]     " 131-165-152
let s:gb.bright_purple  = ['#d3869b', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#8ec07c', 114]     " 142-192-124
